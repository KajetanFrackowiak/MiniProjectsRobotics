...
def main():
    parser = argparse.ArgumentParser(description="Simulate trajectory for manipulation station.")
    parser.add_argument("--visualize-traj", action="store_true", help="Visualize the trajectory in Meshcat.")
    parser.add_argument("--run-teleop-ik", action="store_true", help="Run teleoperation inverse kinematics.")
    parser.add_argument("--run-ik", action="store_true", help="Run inverse kinematics to compute joint positions.")
